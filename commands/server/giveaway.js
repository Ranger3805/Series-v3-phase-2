...
module.exports = {
  config: {
    ...
    aliases: [],
    usage:"<winnercount> <time in secounds 1 day = 86400 secounds> <gift>",
    category: "server",
    setup: "",
  ...
  run: async (bot, message, args) => {
    ...
    if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("Sorry, you cant host a giveaway!");
    ...
    setTimeout(function () {
        ...
        if (peopleReacted.length < winnerCount) {
            return message.channel.send("The people who reacted where less than the winner count.");
        }
