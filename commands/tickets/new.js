...
run : async (bot, message, args) => {   
    ...
    if (!subject) return message.channel.send("❎ **No subject was selected! Please choose: \n 1- ticket \n 2- application **");
    if (subject != "ticket") // first categorypp ly
    if (subject != "application") return message.channel.send("❎ **Invalid subject! Please choose: \n 1- ticket \n 2- application **");
